...
// ── colour tokens (zinc theme) ─────────────────────────────
const ACCENT = "#a1a1aa"; // zinc-400
const ACCENT_BRIGHT = "#d4d4d8"; // zinc-300
const ACCENT_DIM = "rgba(161,161,170,0.25)";
const VOID = "#09090b"; // zinc-950
const MID = "#18181b"; // zinc-900
    ...
    >
      ...
      >
        <div style={{ width: 200, height: 1, background: "rgba(255,255,255,0.08)", overflow: "hidden" }}>
          <div id="lr-loader-bar" style={{ height: "100%", width: "0%", background: ACCENT, boxShadow: `0 0 12px ${ACCENT}` }} />
        </div>
        <div id="lr-loader-pct" style={{ fontSize: 11, letterSpacing: 4, color: "rgba(255,255,255,0.2)" }}>
          000
        </div>
      </div>

      {/* ── Curtains ── */}
      <div id="lr-c-top" style={{ position: "fixed", zIndex: 90, background: "#000", top: 0, left: 0, right: 0, height: "50%", transformOrigin: "top" }} />
      <div id="lr-c-bottom" style={{ position: "fixed", zIndex: 90, background: "#000", bottom: 0, left: 0, right: 0, height: "50%", transformOrigin: "bottom" }} />

      {/* ── Flash ── */}
      <div id="lr-flash" style={{ position: "fixed", inset: 0, zIndex: 200, background: "white", opacity: 0, pointerEvents: "none" }} />
      ...
      {/* ── Glow orbs ── */}
      <div className="lr-orb" style={{ position: "absolute", borderRadius: "50%", pointerEvents: "none", opacity: 0, filter: "blur(80px)", width: 500, height: 500, background: `radial-gradient(circle, rgba(161,161,170,0.12), transparent 70%)`, top: "50%", left: "50%", transform: "translate(-50%,-50%)" }} />
      <div className="lr-orb" style={{ position: "absolute", borderRadius: "50%", pointerEvents: "none", opacity: 0, filter: "blur(80px)", width: 300, height: 300, background: `radial-gradient(circle, rgba(113,113,122,0.2), transparent 70%)`, top: "30%", left: "55%" }} />
      <div className="lr-orb" style={{ position: "absolute", borderRadius: "50%", pointerEvents: "none", opacity: 0, filter: "blur(80px)", width: 250, height: 250, background: `radial-gradient(circle, rgba(161,161,170,0.15), transparent 70%)`, top: "55%", left: "35%" }} />

      {/* ── HUD lines ── */}
      <div className="lr-hline" id="lr-hl-top" style={{ position: "absolute", left: 0, right: 0, height: 1, background: `linear-gradient(90deg, transparent, ${ACCENT}, transparent)`, opacity: 0, transform: "scaleX(0)", boxShadow: `0 0 8px ${ACCENT}`, top: "15%" }} />
      <div className="lr-hline" id="lr-hl-bottom" style={{ position: "absolute", left: 0, right: 0, height: 1, background: `linear-gradient(90deg, transparent, ${ACCENT}, transparent)`, opacity: 0, transform: "scaleX(0)", boxShadow: `0 0 8px ${ACCENT}`, bottom: "15%" }} />
      <div className="lr-hline" id="lr-hl-mid1" style={{ position: "absolute", left: 0, right: 0, height: 1, background: `linear-gradient(90deg, transparent, ${ACCENT}, transparent)`, opacity: 0, transform: "scaleX(0)", boxShadow: `0 0 8px ${ACCENT}`, top: "50%" }} />
      <div className="lr-vline" id="lr-vl-l" style={{ position: "absolute", top: 0, bottom: 0, width: 1, background: `linear-gradient(180deg, transparent, ${ACCENT_DIM}, transparent)`, opacity: 0, transform: "scaleY(0)", left: "12%" }} />
      <div className="lr-vline" id="lr-vl-r" style={{ position: "absolute", top: 0, bottom: 0, width: 1, background: `linear-gradient(180deg, transparent, ${ACCENT_DIM}, transparent)`, opacity: 0, transform: "scaleY(0)", right: "12%" }} />
      ...
      {(
        ...
        >
          <span style={{ position: "absolute", width: "100%", height: 1, top: 0, left: 0, background: ACCENT, boxShadow: `0 0 6px ${ACCENT}` }} />
          <span style={{ position: "absolute", width: 1, height: "100%", top: 0, left: 0, background: ACCENT, boxShadow: `0 0 6px ${ACCENT}` }} />
        </div>
      ))}
      ...
      <div style={{ position: "fixed", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          <circle id="lr-ring1" cx="0" cy="0" r="72" fill="none" stroke={ACCENT_DIM} strokeWidth="20" opacity="0" filter="url(#lr-glow2)" />
          <circle id="lr-ring-spin1" cx="0" cy="0" r="68" fill="none" stroke={ACCENT_DIM} strokeWidth="1" strokeDasharray="8 12" opacity="0" />
          <circle id="lr-ring-spin2" cx="0" cy="0" r="76" fill="none" stroke="rgba(113,113,122,0.18)" strokeWidth="0.8" strokeDasharray="4 16" opacity="0" />
          ...
          <polygon id="lr-hex-outer" points="0,-60 52,-30 52,30 0,60 -52,30 -52,-30" fill="none" stroke={ACCENT} strokeWidth="1.5" opacity="0" />
          <polygon id="lr-hex-inner" points="0,-44 38,-22 38,22 0,44 -38,22 -38,-22" fill="none" stroke="rgba(113,113,122,0.6)" strokeWidth="1" opacity="0" />
          <polygon id="lr-hex-core" points="0,-28 24.2,-14 24.2,14 0,28 -24.2,14 -24.2,-14" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="0.5" opacity="0" />

          <g id="lr-lattice" opacity="0">
            <line className="lr-gline" x1="0" y1="-60" x2="0" y2="60" stroke={ACCENT} strokeWidth="0.5" opacity="0" />
            <line className="lr-gline" x1="-52" y1="-30" x2="52" y2="30" stroke={ACCENT} strokeWidth="0.5" opacity="0" />
            <line className="lr-gline" x1="-52" y1="30" x2="52" y2="-30" stroke={ACCENT} strokeWidth="0.5" opacity="0" />
          </g>
          ...
          >
            ...
            <span
              ...
              style={{
                ...
                color: ACCENT_BRIGHT,
                textShadow: `0 0 20px ${ACCENT}, 0 0 60px ${ACCENT_DIM}`,
                marginLeft: 8,
              }}
            >
              &nbsp;DB
      ...
      <div
        ...
        style={{
          ...
          borderTop: `1px solid rgba(161,161,170,0.06)`,
          display: "flex",
          gap: 40,
          opacity: 0,
          whiteSpace: "nowrap",
